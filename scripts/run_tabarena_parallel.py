...
EXPNAME = str(ROOT / "experiments" / "tabarena_p3a")
EVAL_DIR = ROOT / "eval" / "tabarena_p3a"
WORKER_RESULTS_DIR = ROOT / "experiments" / "tabarena_p3a" / "_worker_results"
...
def get_incomplete_datasets():
    ...
    exp_dir = Path(EXPNAME) / "data" / "GraphDrone_P3A"
    from tabarena.nips2025_utils.tabarena_context import TabArenaContext
    ctx = TabArenaContext()
    meta = ctx.task_metadata
