...
Updated: 2026-03-24T00:21:39.932779+00:00
...
| `v13-reg-afc-allocation-translation` | `v13_regression` | Partially. On a clean-routed 3-dataset quick regression slice with legitimacy gating disabled, rotor alignment remained mechanically real and produced a tiny positive average RMSE delta. But the raw champion/challenger rows did not show a cleaner allocation story: weighted specialist advantage became slightly more negative on average, positive specialist mass slipped slightly, and defer fell overall. So the revisited AFC route is no longer obviously harmful on the clean-routed subset, but it still does not clearly translate geometry into better regression specialist use. | `exp/v13-reg-afc-revisit` | `2026-03-23-v13-reg-afc-revisit.md` |
