...
EXPNAME = str(ROOT / "experiments" / "tabarena_p3e")
EVAL_DIR = ROOT / "eval" / "tabarena_p3e"
WORKER_RESULTS_DIR = ROOT / "experiments" / "tabarena_p3e" / "_worker_results"
N_GPUS = 8
...
def get_incomplete_datasets():
    ...
    exp_dir = Path(EXPNAME) / "data" / "GraphDrone_P3E"
    from tabarena.nips2025_utils.tabarena_context import TabArenaContext
    ctx = TabArenaContext()
    meta = ctx.task_metadata
