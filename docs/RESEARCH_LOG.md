...
| P3-A | `exp/p3-router-val-split` | Router validation split 10%→20% → more stable gradient signal | `model.py:84` | **+77.6** (1540.0 abs, vs baseline 1462.4) | — | 🔁 full run pending | Strong sprint win |
